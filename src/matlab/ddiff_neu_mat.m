...
%       combined field matrix
  ...
  mex_id_ = 'ddiff_neu_mat(i int64_t[x], i int64_t[x], i double[x], i double[xx], i dcomplex[x], io dcomplex[xx])';
[xmat] = kern_mats(mex_id_, n, norder, h, srcinfo, zpars, xmat, 1, 1, 1, 6, n, 2, n, n);
end
%  
%
%
